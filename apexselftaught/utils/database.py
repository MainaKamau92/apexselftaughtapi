...
from django.db import (DatabaseError, IntegrityError, OperationalError,
                       transaction)
from apexselftaught.utils.error_handler import errors
        ...
        while soft_deleted:
            try:
                ...
                if 'violates foreign key constraint' in str(e):
                    ...
                    errors.db_object_do_not_exists(model_name, 'id', self.value, error_type=self.error)
                object_in_db = self.model.all_objects.get(**{self.field: self.value})
