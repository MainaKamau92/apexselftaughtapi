...
from apexselftaught.apps.core.models import TimestampedModel
...
class UserManager(BaseUserManager):
    ...
    def create_superuser(self, username, email, password):
        ...
        user = self.create_user(username=username, email=email, mobile_number='254713116974', password=password)
...
class User(AbstractBaseUser, PermissionsMixin, TimestampedModel):
    ...
    # Changes to true when a user verifies their email.
